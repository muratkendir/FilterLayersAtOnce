...
class FilterLayersAtOnce:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'FilterLayersAtOnce_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&FilterLayersAtOnce')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('FilterLayersAtOnce', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/filter_multiple_layers_at_once/icon.png'
        self.add_action(
            icon_path,
